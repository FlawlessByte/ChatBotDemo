package co.realinventor.chatbotdemo;
...
public class MainActivity extends AppCompatActivity implements AIListener{
    ...
    FirebaseRecyclerAdapter<ChatMessage,MyViewHolder> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AIConfiguration config = new AIConfiguration("7e05881c97bb4a46b5438989c99c8897",
        ...
        adapter = new FirebaseRecyclerAdapter<ChatMessage, MyViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MyViewHolder holder, int position, @NonNull ChatMessage model) {
                if (model.getMsgUser().equals("user")) {
                    ...
                    Log.d("onBindViewHolder","Insider");
                    Log.d("MSG",model.getMsgText());
                    Log.d("Person",model.getMsgUser());

                    holder.setRightText(model.getMsgText());

                    holder.rightText.setVisibility(View.VISIBLE);
                    holder.leftText.setVisibility(View.GONE);
                }
                else {
                    holder.setLeftText(model.getMsgText());
